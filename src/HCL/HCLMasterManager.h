...
/**
 * @brief Manages up to 4 HCL Masters and provides continuous updates
 * 
 * This class:
 * - Manages 4 HCL Master instances
...
class MasterManager {
public:
    static constexpr uint8_t MAX_MASTERS = 4;
    ...
    /**
     * @brief Get a HCL Master by index (1-4)
